...
!function (t) {
    ...
    (function (e) {
      ...
      var u = function u(t) {
        return t && t.Math == Math && t;
          ...
          i = u('object' == (typeof globalThis === 'undefined' ? 'undefined' : _typeof(globalThis)) && globalThis) || u('object' == (typeof window === 'undefined' ? 'undefined' : _typeof(window)) && window) || u('object' == (typeof self === 'undefined' ? 'undefined' : _typeof(self)) && self) || u('object' == _typeof(n) && n) || function () {
        return this;
        ...
        return y.call(t, e);
          ...
          C = !s && !a(function () {
        return 7 != Object.defineProperty((t = 'div', A ? b.createElement(t) : {}), 'a', {
          get: function get() {
            return 7;
          }
        }).a;
      ...
      if (L) {
        ...
        var W = z[j = 'state'] || (z[j] = function (t) {
          return 'Symbol(' + String(void 0 === t ? '' : t) + ')_' + (++q + U).toString(36);
        }(j));

        H[W] = !0, O = function O(t, e) {
      ...
      var X = {
        ...
        (t.exports = function (t, e, u, a) {
          var s,
              ...
              l = !!a && !!a.enumerable,
              h = !!a && !!a.noTargetGet;
          'function' == typeof u && ('string' != typeof e || _(u, 'name') || w(u, 'name', e), (s = n(u)).source || (s.source = r.join('string' == typeof e ? e : ''))), t !== i ? (o ? !h && t[e] && (l = !0) : delete t[e], l ? t[e] = u : w(t, e, u)) : l ? t[e] = u : M(e, u);
        ...
        var n,
            ...
            l = t.global,
            h = t.stat;
        if (n = l ? i : h ? i[o] || M(o, {}) : (i[o] || {}).prototype) for (r in e) {
          if (a = e[r], u = t.noTargetGet ? (s = St(n, r)) && s.value : n[r], !Et(l ? r : o + (h ? '.' : '#') + r, t.forced) && void 0 !== u) {
        ...
        for (var n = Bt(t), r = arguments.length, u = 1, i = vt.f, a = h.f; r > u;) {
          for (var o, l = p(arguments[u++]), c = i ? Dt(l).concat(i(l)) : Dt(l), f = c.length, d = 0; f > d;) {
      ...
      var Pt = ''.repeat || function (t) {
        ...
        return function (e, n, r) {
          var u,
              ...
              o = void 0 === r ? ' ' : String(r),
              l = at(n);
          return l <= s || '' == o ? a : (u = l - s, (i = Pt.call(o, Ot(u / o.length))).length > u && (i = i.slice(0, u)), t ? a + i : i + a);
        };
      },
          It = {
        start: Tt(!1),
      ...
      function Jt(t, e, n, r) {
        return (Jt = 'undefined' != typeof Reflect && Reflect.set ? Reflect.set : function (t, e, n, r) {
          var u,
              i = Wt(t, e);
      ...
      var he = function () {
        function t(e, n, r, u) {
          for (qt(this, t), this.value = e, this.cursorPos = n, this.oldValue = r, this.oldSelection = u; this.value.slice(0, this.startChangePos) !== this.oldValue.slice(0, this.startChangePos);) {
        ...
        return zt(t, [{
          ...
          key: 'removeDirection',
          get: function get() {
            return !this.removedCount || this.insertedCount ? re : this.oldSelection.end === this.cursorPos || this.oldSelection.start === this.cursorPos ? ae : ue;
          }
        }]), t;
      }(),
          ce = function () {
        function t(e) {
          qt(this, t), Object.assign(this, {
            inserted: '',
            rawInserted: '',
            skip: !1,
            tailShift: 0
        ...
        return zt(t, [{
          ...
          value: function value(e) {
            if (String(e)) {
              ...
              if (e instanceof fe) r ? n.extend(e.toString()) : this.chunks.push(e);else if (e instanceof t) {
      ...
      var Ae = function (t) {
        ...
        function n() {
          ...
          return qt(this, n), t.definitions = Object.assign({}, ke, t.definitions), e.call(this, Object.assign({}, n.DEFAULTS, t));
        }
        ...
        return zt(n, [{
          ...
          value: function value() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            t.definitions = Object.assign({}, this.definitions, t.definitions), Xt(Yt(n.prototype), '_update', this).call(this, t), this._rebuildMask();
          }
        }, {
          key: '_rebuildMask',
          value: function value() {
          ...
          key: 'reset',
          value: function value() {
            Xt(Yt(n.prototype), 'reset', this).call(this), this._blocks.forEach(function (t) {
              return t.reset();
            });
          }
        }, {
          ...
          value: function value() {
            ...
            return e === n || this._forEachBlocksInRange(e, n, function (e, n, u, i) {
              ...
              a.stop = t._findStopBefore(n), a.from = t._blockStartPos(n), a instanceof _e && (a.blockIndex = n), r.extend(a);
            }), r;
          }
        }, {
          key: 'extractInput',
          ...
          value: function value(t) {
            ...
            if (e === ue || e === ie) {
              ...
              if (e === ue) for (var w = S + 1; w <= Math.min(l, this._blocks.length - 1); ++w) {
      ...
      Ae.DEFAULTS = {
        lazy: !0,
        placeholderChar: '_'
      }, Ae.STOP_CHAR = '`', Ae.ESCAPE_CHAR = '\\', Ae.InputDefinition = me, Ae.FixedDefinition = ye, de.MaskedPattern = Ae;
      ...
      var Ee = function (t) {
        ...
        return zt(n, [{
          ...
          value: function value(t) {
            ...
            t.mask = u.slice(0, i).replace(/0/g, '\\0') + '0'.repeat(e - i), Xt(Yt(n.prototype), '_update', this).call(this, t);
          }
        }, {
          key: 'isComplete',
          get: function get() {
          ...
          value: function value(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            if (t = Xt(Yt(n.prototype), 'doPrepare', this).call(this, t, e).replace(/\D/g, ''), !this.autofix) return t;
          ...
          value: function value() {
            ...
            for (var u = this.boundaries(e), i = te(u, 2), a = i[0], s = i[1], o = arguments.length, l = new Array(o), h = 0; h < o; h++) {
              l[h] = arguments[h];
            }

            return this.from <= Number(s) && Number(a) <= this.to && (t = Xt(Yt(n.prototype), 'doValidate', this)).call.apply(t, [this].concat(l));
          }
        }]), n;
      }(Ae);
      ...
      var Se = function (t) {
        ...
        return zt(n, [{
          ...
          value: function value() {
            ...
            return (t = Xt(Yt(n.prototype), 'doValidate', this)).call.apply(t, [this].concat(u)) && (!this.isComplete || this.isDateExist(this.value) && null != e && (null == this.min || this.min <= e) && (null == this.max || e <= this.max));
          }
        }, {
          key: 'isDateExist',
          value: function value(t) {
      ...
      var we = function () {
        function t(e, n) {
          qt(this, t), this.el = e instanceof Fe ? e : e.isContentEditable && 'INPUT' !== e.tagName && 'TEXTAREA' !== e.tagName ? new Be(e) : new De(e), this.masked = ge(n), this._listeners = {}, this._value = '', this._unmaskedValue = '', this._saveSelection = this._saveSelection.bind(this), this._onInput = this._onInput.bind(this), this._onChange = this._onChange.bind(this), this._onDrop = this._onDrop.bind(this), this._onFocus = this._onFocus.bind(this), this._onClick = this._onClick.bind(this), this.alignCursor = this.alignCursor.bind(this), this.alignCursorFriendly = this.alignCursorFriendly.bind(this), this._bindEvents(), this.updateValue(), this._onChange();
        }
        ...
        return zt(t, [{
          ...
          set: function set(t) {
            if (!this.maskEquals(t)) if (t instanceof de.Masked || this.masked.constructor !== ve(t)) {
              var e = ge({
                mask: t
              });
      ...
      var Me = function (t) {
        ...
        return zt(n, [{
          key: '_update',
          value: function value(t) {
            t['enum'] && (t.mask = '*'.repeat(t['enum'][0].length)), Xt(Yt(n.prototype), '_update', this).call(this, t);
          }
        }, {
          key: 'doValidate',
          value: function value() {
      ...
      var xe = function (t) {
        ...
        return zt(n, [{
          ...
          value: function value(t) {
            ...
            return (e = Xt(Yt(n.prototype), 'doPrepare', this)).call.apply(e, [this, this._removeThousandsSeparators(t.replace(this._mapToRadixRegExp, this.radix))].concat(u));
          }
        }, {
          ...
          value: function value() {
            ...
            return t = i[0], e = i[1], this._removeThousandsSeparators(Xt(Yt(n.prototype), 'extractInput', this).call(this, t, e, r));
          }
        }, {
          key: '_appendCharRaw',
          value: function value(t) {
      ...
      var Oe = function (t) {
        ...
        return zt(n, [{
          key: '_update',
          value: function value(t) {
            Xt(Yt(n.prototype), '_update', this).call(this, t), 'mask' in t && (this.compiledMasks = Array.isArray(t.mask) ? t.mask.map(function (t) {
              return ge(t);
            }) : []);
          }
        }, {
          ...
          value: function value() {
            ...
            return (t = Xt(Yt(n.prototype), 'doValidate', this)).call.apply(t, [this].concat(u)) && (!this.currentMask || (e = this.currentMask).doValidate.apply(e, u));
          }
        }, {
          key: 'reset',
          value: function value() {
          ...
          set: function set(t) {
            ...
            this.compiledMasks.forEach(function (t, n) {
              return t.state = e[n];
            }), null != r && (this.currentMask = r, this.currentMask.state = u), Qt(Yt(n.prototype), 'state', i, this, !0);
          }
        }, {
          key: 'extractInput',
          value: function value() {
          ...
          value: function value() {
            ...
            return this.currentMask ? (t = this.currentMask).extractTail.apply(t, u) : (e = Xt(Yt(n.prototype), 'extractTail', this)).call.apply(e, [this].concat(u));
          }
        }, {
          key: 'doCommit',
          value: function value() {
          ...
          value: function value() {
            ...
            return this.currentMask ? (t = this.currentMask).nearestInputPos.apply(t, u) : (e = Xt(Yt(n.prototype), 'nearestInputPos', this)).call.apply(e, [this].concat(u));
          }
        }, {
          key: 'overwrite',
          get: function get() {
      ...
      e.HTMLContenteditableMaskElement = Be, e.HTMLMaskElement = De, e.InputMask = we, e.MaskElement = Fe, e.Masked = pe, e.MaskedDate = Se, e.MaskedDynamic = Oe, e.MaskedEnum = Me, e.MaskedFunction = Pe, e.MaskedNumber = xe, e.MaskedPattern = Ae, e.MaskedRange = Ee, e.MaskedRegExp = be, e.PIPE_TYPE = Te, e.createMask = ge, e.createPipe = Ie, e['default'] = de, e.pipe = je, Object.defineProperty(e, '__esModule', {
        value: !0
      });
    })(e);
  }).call(this, n(2));
  ...
  window.onscroll = function () {
    ...
    t > 2 * e.clientHeight ? e.classList.add('_transform') : e.classList.remove('_transform'), t > window.innerHeight - e.clientHeight ? e.classList.add('_visible') : e.classList.remove('_visible'), t > 1.5 * window.innerHeight ? n.classList.remove('_disabled') : n.classList.add('_disabled');
  };
}, function (t, e) {
  var n;
  ...
  var a = function a(t) {
    r.querySelector('.thanks__title').innerHTML = t, i.classList.remove('_disabled'), r.classList.remove('_disabled');
  },
      s = n(0),
      o = n.n(s);
  ...
  function l(t, e) {
    ...
    n.forEach(function (t) {
      t.addEventListener('click', function () {
        'true' === t.value ? (r.classList.remove('_disabled'), r.lastElementChild.disabled = !1) : (r.classList.add('_disabled'), r.lastElementChild.value = '', r.lastElementChild.disabled = !0);
      });
    });
  }
  ...
  document.querySelectorAll('._scroll-goto[data-goto]').forEach(function (t) {
    t.addEventListener('click', function (e) {
      e.preventDefault(), t.dataset['goto'] && document.querySelector(t.dataset['goto']) && window.scrollTo({
        top: document.querySelector(t.dataset['goto']).offsetTop,
        behavior: 'smooth'
      }), document.body.classList.remove('_look'), h.classList.remove('_active'), c.classList.remove('_active');
    });
  });
  document.querySelectorAll('.gallery__like').forEach(function (t) {
    var e = t,
        n = t.nextElementSibling;
    n.innerHTML = 1 + Math.floor(11 * Math.random()), console.log(n.textContent), e.addEventListener('click', function (t) {
      t.preventDefault(), e.classList.contains('icon-heart-transparent') ? (e.classList.remove('icon-heart-transparent'), e.classList.add('icon-heart-solid'), n.innerHTML = +n.textContent + 1) : (e.classList.remove('icon-heart-solid'), e.classList.add('icon-heart-transparent'), n.innerHTML = +n.textContent - 1);
    });
  });
  ...
  f.addEventListener('submit', function (t) {
    ...
    e.querySelector('button[type="submit"]').disabled = !0, function (t) {
      var e = t.querySelector('button[type="submit"]');
      t.reset(), t.querySelector('#blockAlcoholType').classList.add('_disabled'), t.querySelector('#blockNumOfChildren').classList.add('_disabled'), e.disabled = !1;
    }(e), d.updateValue(), p.updateValue(), a(r);
  }), l('children', 'blockNumOfChildren'), l('drink', 'blockAlcoholType');
}]);